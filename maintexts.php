...
.lol {
    ...
    <body bgcolor="grey" text="black" vlink="#FF9933" link="#FF0033">
        ...
        <div style="position: absolute; top: 260; left: 400; width: 1000px; text-align:left;">
            ...
            <button class="buttonshadow buttonsha" onclick="location.href='http://localhost/RCS/txtfl.php'" type="button">First Look</button> <br> <br> <br> <br>
           <?php 
            if($_SERVER["REQUEST_METHOD"] == "POST")
                {
                    $szukaj = mysqli_real_escape_string($link, $_POST['szukaj']);
                    $txt ="select id_tekstu, temat, kategoria from TEKST where temat like '%$szukaj%' order by data_publikacji desc";
                    ?>
                ...
                {
                    $txt ="select id_tekstu, temat, kategoria from TEKST order by data_publikacji desc";
                }
                    ...
                    <div style="font-size: 25pt;">
                        <a style="text-decoration: none" href = "text.php?id=<?php echo $idtxt; ?>" > <?php echo $kat; echo htmlspecialchars(": $temat"); ?> </a> <br> <br>
                    </div>      
                    <?php
                        }
                    ?>
